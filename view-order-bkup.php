...
<div class="row-fluid">
	...
	<div class="box span12">
		...
		<div class="box-content" id="print_inv">
            ...
            $get_o_date=mysql_fetch_array(mysql_query($o_query));
                ...
                $custname=mysql_fetch_array(mysql_query("select cust_name from tblorder where ord_code='$order'"));
			...
			<div style="width:100%; height:50px; background-color:pink">
				<div style="height: 100px; width:100px; display: block; background: purple; margin-left: 25px; ">
					<h2 style="color: white; text-align: center;line-height: 50px;">ORDER</h2>
					<h2 style="color: white; text-align: center;line-height: 50px;"></h2>
				</div>
			</div>
			...
			<div style="width: 250px; float: right;">
				...
				<div style="height: 40px;"></div>
				<span style="float: left; width:80px">Order No:</span><span style="width:50px; text-align: left"><?php echo $order; ?></span><br />
		...
		<?php		$sr=$sr+1;
			...
			<!-- <div style="width:80px;; height:60px; background-color:purple; position:absolute; z-index:9999; margin:-50px 20px 1px; padding:10px;">
			<h3>Invoice</h3>
			</div> -->
	...
	<a class="btn" href="#">Print Order</a>
	<?php if (empty($get_o_date['inv_code'])) {
                ?>
		<a class="btn" href="invoice.php?order=<?php echo $order; ?>">Creat  Invoice</a>
	<?php
            } else {
                ?>
		<a class="btn" href="invoice.php?order=<?php echo $order; ?>">View  Invoice</a>
	<?php
            }  ?>
