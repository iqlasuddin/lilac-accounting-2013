						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
						  	<?php
                                ...
                                $q="SELECT * FROM tblinvoice_direct WHERE status=1 ORDER BY inv_id DESC limit 0,200";
                                $run=mysql_query($q);
                                if ($run) {
								...
								<tr <?php echo $strikethru; ?>>
									...
									<?php if ($inv['status']==1) {
										...
										<!--<a class="btn btn-info" title="Edit the invoice" href="edit-instant-invoice?inv=<?php //echo $inv['inv_id'];?>">
