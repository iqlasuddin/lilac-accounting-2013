...
<head>
	...
	<meta charset="utf-8">
	<title>Lucky Lilac WLL : IQSUITE Accounting Application </title>
			...
			<div>
				...
				<div class="box span12">
					<div class="box-header well">
						<h2><i class="icon-info-sign"></i> Your License has expired!</h2>
					</div>
					<div class="box-content">
						
				
				<h3> License Information </h3>
				<p> The License for the product has expired. Please contact support@iqlas.com to renew the license.</p>
