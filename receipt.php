...
$id=$_GET['r'];
$q="SELECT r.*,o.cust_name,o.cus_mobile,o.o_grand,i.* FROM tblrcpt r, tblorder o, tblinvoice i WHERE r.id=$id AND o.inv_code=r.inv_code and i.i_id=r.inv_code";
...
.footer-notice{font-size:11px; margin-top:-10px; text-align:center;}
						...
						<div class="container" style="border:0px solid #000;"> 
							...
							<tr > 
							<td > Name </td>
							<td colspan=3><b> <?php echo $receipt->cust_name."/".$receipt->cus_mobile;?> </b> </td> 
							</tr>
