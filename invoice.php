...
?>
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="#">Genarate Invoice </a><span class="divider">/</span>
					</li>
					<li>
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-share"></i> Genarate Invoice</h2>
					...
					<div class="form-actions">
                        ...
                        if (empty($inv_check)) {
                            ?>
							<button class="btn btn-primary" onclick="invoice('<?php echo $invoice; ?>','<?php echo $order; ?>','<?php echo $get_o_date['o_grand']; ?>','0');" > Save Invoice</button>
							 <button class="btn btn-primary" onclick="invoice('<?php echo $invoice; ?>','<?php echo $order; ?>','<?php echo $get_o_date['o_grand']; ?>','1');" > Save Invoice and Print </button>
			<?php
                        } else {
                            ?>
...
.footer-notice{font-size:11px; margin-top:-10px; text-align:center;}
						...
						<div class="container" style="border:0px solid #000;"> 
							...
							<div name="invoice" style="width:300px; height:125px; float:left;"> <h1 style="margin:15px auto auto 90px; font-family:calibri,arial,sans-serif "> Invoice - <?php echo $invoice; ?> </h1> 
							...
							<td class="invoice-details-labels"> Invoice date </td>
...
<?php $remaining = 13-$sr;
    for ($i=0; $i<=$remaining; $i++) {
        ?>	
 	<tr>
									<td class="align-center"> <?php echo '<span style="color:#fff"> - </span>'; ?> </td>
									<td>  </td>
									<td class="center"> </td>
									<td> </td>
									<td> </td>
...
<?php
							...
							<tr>
							<td class="align-left" valign=top colspan=3 rowspan=5> NOTES: <br /> Oryx Doha is not responsible for items after 3 months. </td>
